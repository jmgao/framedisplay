...
class MBAACC_CG {
 protected:
  ...
  void copy_cells(const MBAACC_CG_Image* image, const MBAACC_CG_Alignment* align,
                  unsigned char* pixels, unsigned int x1, unsigned int y1, unsigned int width,
                  unsigned int height, unsigned int* palette, bool is_8bpp);
 ...
 public:
  ...
  Texture* draw_texture(unsigned int n, unsigned int* palette, bool to_pow2, bool draw_8bpp = 0);
