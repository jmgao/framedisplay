...
class MBAA_TileImage {
 ...
 public:
  void copy_region_to(unsigned char* pixels, int dx, int dy, int dw, int dh, int sx, int sy, int sw,
                      int sh, unsigned int* palette, bool is_8bpp);
...
class MBAA_CG2 {
 ...
 public:
  ...
  Texture* draw_texture(unsigned int n, MBAA_ARX* arx, unsigned int* palette, bool to_pow2,
                        bool draw_8bpp = 0);
