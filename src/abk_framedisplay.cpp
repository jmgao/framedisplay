...
static const ABK_Character_Info abk_character_info[] = {
    {"Akatsuki", "aka"}, {"Mycale", "myc"},  {"Sai", "sai"},       {"Kanae", "kan"},
    {"Fritz", "fri"},    {"Marilyn", "mar"}, {"Wei", "pow"},       {"Anonym", "ano"},
    {"Soldat", "sol"},   {"Adler", "adl"},   {"Blitztank", "tan"}, {"Murakumo", "bos"},
    {"Dice", "dic"}};
...
const char* ABK_FrameDisplay::get_character_long_name(int n) { return get_character_name(n); }

int ABK_FrameDisplay::get_sequence_count() { return m_framedata.get_sequence_count(); }

bool ABK_FrameDisplay::has_sequence(int n) { return m_framedata.has_sequence(n); }

int ABK_FrameDisplay::get_frame_count() { return m_framedata.get_frame_count(m_sequence); }

int ABK_FrameDisplay::get_subframe() { return m_subframe_base; }
...
bool ABK_FrameDisplay::init() { return init(""); }
